...
describe('Site 요구사항 테스트', () => {
    ...
    test('2.Site에는 Board를 추가하고 추가된 Board를 조회할 수 있다.', () => {
    ...
    test('3.하나의 Site에 동일한 이름의 Board를 추가할 수 없다.', () => {
        const mySite = new Site();
...
describe('Board 요구사항 테스트', () => {
    ...
    test('5. Board는 name 데이터를 포함해야 하며 null 또는 빈 문자열("")은 허용하지 않는다.', () => {
        expect(() => {
    ...
    test('6.Site 에 추가된 Board만 사용 가능한 것으로 간주하며 사용 불가능한 Board에는 Article을 추가할 수 없다.', () => {
    ...
    test('7.Board에 Article을 추가할 때 Article에 ID를 자동 생성해서 부여해야 한다.', () => {
        const noticeBoard = new Board('공지사항');
        mySite.addBoard(noticeBoard);
    ...
    test('8.Board에 Article을 추가할 때 Article에 작성 일자가 들어가야 한다.', () => {
        const noticeBoard = new Board('공지사항');
        mySite.addBoard(noticeBoard);
    ...
    test('9.Article 은 n개 이상 추가 할 수 있다.', () => {
        const noticeBoard = new Board('공지사항');
        mySite.addBoard(noticeBoard);
    ...
    test('10.작성된 Article 목록을 조회 할 수 있어야 한다.', () => {
        const noticeBoard = new Board('공지사항');
        mySite.addBoard(noticeBoard);
...
describe('Article 요구사항 테스트', () => {
    ...
    test('11.Article은 subject, content, author 3개의 데이터를 포함해야 하며 null 또는 빈 문자열("")은 허용하지 않는다.', () => {
    ...
    test('12.Board에 추가된 Article만 사용 가능한 것으로 간주하며 사용 불가능한 Article에는 Comment를 추가할 수 없다.', () => {
        const noticeBoard = mySite.findBoardByName('공지사항');
    ...
    test('13.Article에 Comment를 추가할 때 Comment에 작성 일자가 들어가야 한다.', () => {
        const noticeBoard = mySite.findBoardByName('공지사항');
    ...
    test('14.Comment는 n개 이상 추가 할 수 있다.', () => {
        const noticeBoard = mySite.findBoardByName('공지사항');
    ...
    test('15.작성된 Comment 목록을 조회 할 수 있어야 한다.', () => {
        const noticeBoard = mySite.findBoardByName('공지사항');
...
describe('Comment 요구사항 테스트', () => {
    ...
    test('16.Comment는 content, author 2개의 데이터를 포함해야 하며 null 또는 빈 문자열("")은 허용하지 않는다.', () => {
        const noticeBoard = mySite.findBoardByName('공지사항');
